                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('admin/ogunekle')?>" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-skill">Günler <span class="text-danger">*</span>
                                            </label>
                                         <div class="col-md-6">
    
                                        <input type="text" name="gun" class="form-control" value="2017-06-04" id="mdate">
                                        </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-skill">Yemekler <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
